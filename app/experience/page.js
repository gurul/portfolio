...
const experience = [
  {
    ...
    description:
      "designed a prompt-driven storytelling kiosk and multi-model video pipeline that captured 600+ stories",
  },
  {
  ...
  },
  {
    ...
    description:
      "optimized growth systems for outreach and referrals that streamlined sourcing and lifted conversion by 11%",
  },
  {
    company: "Yelo",
    role: "Growth Intern",
    ...
    description:
      "sparked 300K+ views through content-led growth experiments",
  },
  {
    ...
    description:
      "prototyped a 92%-accurate AI ticket-routing platform and multi-agent workflow UI for investor demos",
  },
  {
    ...
    description:
      "assessed early-stage startups, developed investment theses, and participated in partner mentorship sessions",
  },
  {
    company: "cseed",
  ...
  },
  {
    ...
    description:
      "analyzed LLM bias across models, datasets, and alignment strategies while building multilingual pipelines",
  },
  {
    company: "PwC",
  ...
  },
  {
    ...
    description:
      "mapped 27K+ researchers with fuzzy-matching pipelines and co-authored a PLOS Digital Health publication",
  },
  {
    ...
    description:
      "investigated algorithmic bias and AI governance",
  },
  {
    company: "Forsys Inc",
    role: "Software Engineer Intern",
    ...
    description:
      "implemented revenue engineering systems and backend workflows",
  },
  {
    ...
    description:
      "devised ML methods for signal processing across particle and gravitational data",
  },
];
